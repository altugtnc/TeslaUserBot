...
UNAPPROVED_MSG = ("`Hey! Bu bir Tesla botu. Endişelenme.\n\n`"
...
try:
    ...
    PLUGIN_MESAJLAR = {}
    ORJ_PLUGIN_MESAJLAR = {"alive": "`🤡 Tesla Userbot hizmetinizde 🌀.`", "afk": str(choice(AFKSTR)), "kickme": "Bir daha görüşmemek üzere ben gidiyoree 👻", "pm": UNAPPROVED_MSG, "dızcı": str(choice(DIZCILIK_STR))}
...
LOGS.info("Botunuz çalışıyor! Herhangi bir sohbete .alive yazarak Test edin."
          " Yardıma ihtiyacınız varsa, Destek grubumuza gelin t.me/TeslaUserBot")
LOGS.info("Bot sürümünüz Tesla v1.3")
